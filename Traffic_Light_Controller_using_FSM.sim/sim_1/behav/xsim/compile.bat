...
REM
REM Generated by Vivado on Thu May 21 00:23:56 +0530 2026
...
echo "xvlog --incr --relax -prj traffic_light_controller_tb_vlog.prj"
call xvlog  --incr --relax -prj traffic_light_controller_tb_vlog.prj -log xvlog.log
